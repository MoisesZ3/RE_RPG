...
if __name__ == '__main__':
    ...
    print('''
  ( ) Faca de Combate          [ DESCRIÇÃO ]
  ( ) Pistola 9mm              Erva amarela encontrada nas
  (>) Erva Amarela             montanhas de Arklay. 
  ( ) Munição (12)             Aumenta a vida máxima 
  ( ) Chave da Mansão          permanentemente.
  ( ) --- Vazio ---
''')
